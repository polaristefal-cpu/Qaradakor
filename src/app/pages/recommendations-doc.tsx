 ...
 * реализованный в /supabase/functions/make-server-59141208/index.ts
 */
...
finalScore = 0.833×0.35 + 1.000×0.20 + 0.840×0.20
        ...
        <p className="text-center text-muted-foreground/40 text-xs pt-4">
          qaradakor.kz — алгоритм рекомендаций v1 · /supabase/functions/make-server-59141208/index.ts
        </p>
      </div>
    </div>
  );
