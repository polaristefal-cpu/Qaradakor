...
async function buildDocument() {
  ...
  const chapter5 = [
    ...
    para("Все маршруты в /supabase/functions/make-server-59141208/index.tsx. Группы: Auth, Profile, TMDB Proxy, Watched, Watchlist, Reviews, Friends, AI, Recommendations."),
